          ...
          <div class="nav-container">
            <ul id="main-menu-navigation" data-menu="menu-navigation" data-scroll-to-active="true" class="navigation navigation-main">
              ...
              <li class="has-sub nav-item"><a href="#">
                <i class="ft-home"></i>
                <span data-i18n="" class="menu-title">Administradores</span><span class="tag badge badge-pill badge-danger float-right mr-1 mt-1"></span></a>
                  <ul class="menu-content">
                    <li><a href="{{ route('registro') }}" class="menu-item">Agregar Administradores</a>
                    </li>
              ...
              <li class="has-sub nav-item"><a href="#">
                <i class="ft-image"></i>
                <span data-i18n="" class="menu-title">Agregar Información</span><span class="tag badge badge-pill badge-danger float-right mr-1 mt-1"></span></a>
                  <ul class="menu-content">
              ...
              <li class=" nav-item">
                <a href="{{ route('salir') }}">
                  ...
                  <span data-i18n="" class="menu-title">Salir</span>
                </a>
              </li>
